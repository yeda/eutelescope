...
#$ -cwd
#### Your job name 
#$ -N TB5_TelescopeAlignment
#
# where to put the logfiles
#$ -o /nfs/dust/atlas/user/yeda/ilcsoft/v01-17-05/Eutelescope/trunk/jobsub/examples/alibava/gblPython/TelescopeAlignment/TB5_TelescopeAlignment/qsublogs
### Job requirements:
#
### necessary cpu time:
#####$ -l h_cpu=80:00:00
...
outputPath="${gblPythonPath}/TelescopeAlignment/TB5_TelescopeAlignment"
...
/usr/bin/python "${basePath}/gearUpdate.py" -og "${outputPath}/template-gear-tb5-it11.xml" -ng "${outputPath}/template-gear-tb5-it12.xml"
