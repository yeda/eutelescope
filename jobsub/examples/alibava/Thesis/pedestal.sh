...
TEMPLATELIST=('alibava-convert-ped' 'alibava-rawdatahisto' 'alibava-pedestal' 'alibava-commonmode' 'alibava-pedestal-subtracted-rawdatahisto' 'alibava-pedestal2')

for TEMPLATE in $TEMPLATELIST; do
	jobsub -c config/ChapReco-nocut.cfg -csv ../runlistfiles/pedestal_runlist_all.csv $TEMPLATE $@
